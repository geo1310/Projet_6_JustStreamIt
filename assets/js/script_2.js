(function () {
    const nb_images = 10;
    const left_button = document.querySelector("#category-2 .button-left");
    const right_button = document.querySelector("#category-2 .button-right");
    const container = document.querySelector("#category-2 .container");
    let position = 0;
