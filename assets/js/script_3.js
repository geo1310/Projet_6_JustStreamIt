(function () {
    const nb_images = 10;
    const left_button = document.querySelector("#category-3 .button-left");
    const right_button = document.querySelector("#category-3 .button-right");
    const container = document.querySelector("#category-3 .container");
    let position = 0;
