(function () {
    const nb_images = 10;
    const left_button = document.querySelector("#category-best .button-left");
    const right_button = document.querySelector("#category-best .button-right");
    const container = document.querySelector("#category-best .container");
    let position = 0;
