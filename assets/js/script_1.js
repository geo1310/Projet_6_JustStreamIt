(function () {
    const nb_images = 10;
    const left_button = document.querySelector("#category-1 .button-left");
    const right_button = document.querySelector("#category-1 .button-right");
    const container = document.querySelector("#category-1 .container");
    let position = 0;
